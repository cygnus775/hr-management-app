...
import { User, Mail, Phone, Building2, Calendar, CreditCard, Edit3, Save, X, Upload, Download, Trash2, FileText, Loader2, AlertCircle } from 'lucide-react'
                ...
                <DialogContent>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Select
                        value={uploadDocType}
                        onValueChange={(value) => setUploadDocType(value as DocumentType)}
                      >
                        <SelectTrigger>
